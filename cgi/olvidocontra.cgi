...
if (@r){
        ...
        my $body = "<h1>Buenas, $id </h1> <p> Ha solicitado el recuerdo de contraseña, para la próxima vez apuntesela en un papel</p> <p>Su contraseña es: $decode </p><small> Att: El admin</small>";
